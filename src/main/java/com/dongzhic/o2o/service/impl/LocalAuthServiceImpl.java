...
import com.dongzhic.o2o.dao.LocalAuthDao;
...
import com.dongzhic.o2o.util.MD5Util;
...
public class LocalAuthServiceImpl implements LocalAuthService {
    ...
    @Override
    public LocalAuth getLocalAuthByUserNameAmdPwd(String userName, String password) {
        return localAuthDao.queryLocalByUserNameAmdPwd(userName, MD5Util.MD5Encode(password));
    }
    ...
    public LocalAuthExecution bindLocalAuth(LocalAuth localAuth) throws LocalAuthOperationException {
        ...
        // 查询此用户是否已绑定过平台帐号
        LocalAuth isLocalAuth = localAuthDao.queryLocalByUserId(localAuth.getPersonInfo().getUserId());
        if (isLocalAuth != null) {
        ...
        try {
            ...
            // 对密码进行MD5加密
            localAuth.setPassword(MD5Util.MD5Encode(localAuth.getPassword()));
    ...
    public LocalAuthExecution modifyLocalAuth(long userId, String userName, String password, String newPassword) throws LocalAuthOperationException {
        ...
        if (userId != 0 && userName != null && password != null && newPassword != null
            ...
            try {
                // 更新密码，并对新密码进行MD5加密
                int effectedNum = localAuthDao.updateLocalAuth(userId, userName, MD5Util.MD5Encode(password), MD5Util.MD5Encode(newPassword), new Date());
                // 判断更新是否成功
                if (effectedNum <= 0){
                    throw new LocalAuthOperationException("跟新密码失败");
                } else {
